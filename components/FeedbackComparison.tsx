  ...
  if (isLoading) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
        <div className="bg-gray-900 border border-gray-700 rounded-lg p-8 max-w-2xl w-full mx-4">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"></div>
            <h2 className="text-xl font-semibold mb-2 text-white">Loading Comparison</h2>
            <p className="text-gray-300">Preparing your A/B comparison...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
        <div className="bg-gray-900 border border-gray-700 rounded-lg p-8 max-w-2xl w-full mx-4">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-4">Failed to load comparison data</p>
            <button
              onClick={onClose}
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-lg max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Summary A */}
            <div className="border-2 border-gray-600 rounded-lg p-4 hover:border-blue-400 transition-colors bg-gray-800">
          ...
          <div className="mt-6 p-4 bg-gray-800 border border-gray-600 rounded-lg">
            <div className="flex items-start">
              ...
              <div>
                <h5 className="font-semibold text-white mb-1">Tips for Comparison</h5>
